# 🚀 개인용 자동화 스크립트 모음 (Personal Automation Scripts)

개인 PC 사용 환경을 최적화하고, 바탕화면 전환이나 오디오 장치 변경 같은 반복 작업을 자동화하기 위해 만든 스크립트 모음집입니다.
...
2.  "키보드 바로 가기 키" 할당 메뉴로 이동합니다. (`setup-for-logitech-01.png` 참고)
3.  할당할 키를 입력받는 창이 뜨면, **키보드를 누르는 대신** `hotkey_input_simulator.ahk` 스크립트를 수정하여 실행합니다.
    ...
    * **방법:**
        ...
        4.  로지텍 설정 창이 이 입력을 자동으로 감지하여 버튼에 F14 키가 할당됩니다. (`setup-for-logitech-02.png` 참고)
...
2.  "바로 가기 키" 팝업 창이 뜨면, **"키보드로 입력" 아래의 검은색 입력 칸을 클릭합니다.** (`xppen-fkey-setup-02.png` 참고)
